...
const benefitsData = [{
  icon: <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-clinic-blue">
...
export function Benefits() {
  return <section id="benefits" className="py-16 bg-gradient-to-b from-clinic-white to-gray-100 md:py-[82px]">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {benefitsData.map((benefit, index) => <Card key={index} className="p-6 border border-gray-200 hover:border-clinic-blue/50 transition-colors hover:shadow-lg">
